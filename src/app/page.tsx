          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.08]">
                Documenta y verifica la <span className="text-amber-500 italic">genealogía</span> de tu ejemplar en línea.
              </h1>
            ...
            <div className="relative animate-scale-in" style={{ animationDelay: "120ms" }}>
              ...
              <div className="relative rounded-3xl border border-border bg-card p-6 shadow-elevation-3 transition-transform duration-500 hover:-translate-y-1">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-xs text-muted-foreground">Nro. de registro ABCI</p>
                    <p className="font-mono font-semibold tabular-nums">29601</p>
                  </div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-amber-500/10 via-background to-amber-500/5 border border-border p-6 cert-watermark">
                  <div className="flex items-start justify-between mb-5">
                    <div>
                      ...
                      <h3 className="font-display text-2xl font-semibold mt-1">FIGHTING BULL MILI</h3>
                      <p className="text-sm text-muted-foreground">American Bully — Pocket</p>
                    </div>
                    <DogIcon className="w-12 h-12 text-amber-500" strokeWidth={1.5} />
                  </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Reveal key={s.label} delay={i * 60}>
                <div className="rounded-2xl border border-border bg-card p-5 text-center shadow-elevation-1 transition-all duration-300 hover:shadow-elevation-2 hover:-translate-y-0.5">
                  <p className="font-display text-3xl font-semibold tracking-tight text-amber-500 tabular-nums">{s.num}</p>
          ...
          {[
            ...
            <Reveal key={f.title} delay={(i % 3) * 60}>
              <Card hoverable className="group h-full">
                <div className="inline-flex w-12 h-12 rounded-xl bg-amber-500/10 items-center justify-center transition-all duration-300 group-hover:bg-amber-500 group-hover:text-black group-hover:scale-110">
                  <f.Icon className="w-6 h-6 text-amber-500 group-hover:text-black transition-colors" strokeWidth={1.75} />
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <Reveal key={f.title} delay={(i % 2) * 80}>
                <Link href={f.href} className="group block h-full rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:border-amber-500/50 hover:shadow-elevation-3 hover:-translate-y-1 relative overflow-hidden cursor-pointer">
                  <div className="absolute top-4 right-4">
                    <Badge variant="accent">{f.tag}</Badge>
                  </div>
                  <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-600 items-center justify-center text-black transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                  ...
                  <p className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-amber-500">
                    Probar ahora <ArrowRight className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-1" />
                  </p>
                </Link>
              </Reveal>
            ))}
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6 relative">
          {[
            ...
            <Reveal key={s.n} delay={i * 80}>
              <div className="rounded-2xl border border-border bg-card p-8 relative transition-all duration-300 hover:shadow-elevation-2 hover:-translate-y-0.5 h-full">
                <span className="absolute -top-3 left-6 inline-flex w-14 h-7 items-center justify-center rounded-full bg-amber-500 text-black text-xs font-bold tracking-widest tabular-nums">{s.n}</span>
        ...
        <Reveal>
          <div className="relative rounded-3xl overflow-hidden border border-amber-500/30 bg-gradient-to-br from-black via-zinc-950 to-black text-white p-12 sm:p-16 text-center">
            ...
            <div className="relative">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-semibold tracking-tight leading-[1.15]">¿Listo para dar a tu sangre un pasaporte internacional?</h2>
